...
🔑 Key Features
1. Financial KPI Analysis – Track Total Revenue, Interest, Income, and Customer Satisfaction Score (CSS).
2. Customer Demographic Analysis – Analyze customers by age, gender, education, marital status, salary group, and dependents.
3. Customer & Regional Insights – Compare revenue across customer jobs and top-performing states using interactive filters.
